...
function useGuessChecker(charMap: PuzzleWordCharCountType, word: string, guess: GuessType) {
	...
	const checkedGuess = guess.map((char, i): { status: GuessedCharStatus; char: string } => {
...
// [{status:'incorrect', char:'b'}, {status:'correct', char:'e'}]

export default function SubmittedGuess({ guess, puzzleWord, puzzleWordCharCount }: SubmittedGuessProps) {
